...
//            [arrayOfNSNums addObject:@(arc4random_uniform(10000))];
        ...
        NSInteger binarySearchResult = [binarySearch binarySearch:@100 minIndex:0 maxIndex:[arrayOfNSNums count] - 1 in:arrayOfNSNums];
        ...
        NSInteger linearSearchResult = [linearSearch linearSearchFor:@100 in:arrayOfNSNums];
        endTime = [NSDate date];
